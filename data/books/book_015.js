...
export const meta = {
  ...
  emoji: '📖',
  cover: 'visual/book_covers/book_015.png',
...
export const chapters = [
  {
    id: 'ch1',
    title: '第一章：周南 · 召南',
    unlockAt: 0, words: 1784,
    preview: '关关雎鸠，在河之洲。窈窕淑女，君子好逑。参差荇菜，左右流之。',
    previewEn: 'Guan-guan cry the ospreys on the islet in the river. The gentle, graceful lady—fit bride for a lord.',
    highlight: '窈窕淑女，君子好逑。',
    content: `周南
...
彼茁者蓬，壹发五豵，于嗟乎驺虞！`
  },
  {
    id: 'ch2',
    title: '第二章：邶 · 鄘 · 卫 · 王',
    unlockAt: 1784, words: 4796,
    preview: '泛彼柏舟，亦泛其流。耿耿不寐，如有隐忧。微我无酒，以敖以游。',
    previewEn: 'Drifting goes that cypress boat, drifting on the current. Wide awake I lie, as if with hidden grief.',
    highlight: '知我者，谓我心忧；不知我者，谓我何求。',
    content: `邶风
...
丘中有李，彼留之子。彼留之子，贻我佩九。`
  },
  {
    id: 'ch3',
    title: '第三章：郑 · 齐 · 魏 · 唐',
    unlockAt: 6580, words: 4167,
    preview: '风雨凄凄，鸡鸣喈喈。既见君子，云胡不夷。',
    previewEn: 'Wind and rain, cold and chill; the cock crows kee-kee. Since I have seen my lord, how can I not be at peace?',
    highlight: '一日不见，如三秋兮。',
    content: `郑风
...
采葑采葑，首阳之东。人之为言，苟亦无从。舍旃舍旃，苟亦无然。人之为言，胡得焉？`
  },
  {
    id: 'ch4',
    title: '第四章：秦 · 陈 · 桧 · 曹 · 豳',
    unlockAt: 10747, words: 3267,
    preview: '蒹葭苍苍，白露为霜。所谓伊人，在水一方。',
    previewEn: 'The reeds grow tall and grey; white dew turns to frost. The one I seek is somewhere beyond the water.',
    highlight: '七月流火，九月授衣。',
    content: `秦风
...
狼疐其尾，载跋其胡。公孙硕肤，德音不瑕？`
  },
  {
    id: 'ch5',
    title: '第五章：小雅（一）',
    unlockAt: 14014, words: 6424,
    preview: '呦呦鹿鸣，食野之苹。我有嘉宾，鼓瑟吹笙。',
    previewEn: 'Yo-yo cry the deer, eating wild artemisia. I have honored guests—strike the zither, blow the sheng.',
    highlight: '呦呦鹿鸣，食野之苹。我有嘉宾，鼓瑟吹笙。',
    content: `《鹿鸣》
...
莫高匪山，莫浚匪泉。君子无易由言，耳属于垣。无逝我梁，无发我笱。我躬不阅，遑恤我后。`
  },
  {
    id: 'ch6',
    title: '第六章：小雅（二）',
    unlockAt: 20438, words: 5626,
    preview: '鹤鸣于九皋，声闻于野。鱼潜在渊，或在于渚。',
    previewEn: 'The crane cries from the deep marsh, its voice heard across the wilds. Fish hide in the deep, or rest in the shallows.',
    highlight: '他山之石，可以攻玉。',
    content: `《巧言》
...
有芃者狐，率彼幽草。有栈之车，行彼周道。`
  },
  {
    id: 'ch7',
    title: '第七章：大雅',
    unlockAt: 26064, words: 8326,
    preview: '文王曰：咨！咨女殷商。匪上帝不时，殷不用旧。',
    previewEn: 'King Wen said: Ah! Hear me, Yin of Shang. It is not that God is untimely—Yin would not keep its old ways.',
    highlight: '靡不有初，鲜克有终。',
    content: `《文王》
...
昔先王受命，有如召公，日辟国百里，今也日蹙国百里。于乎哀哉！维今之人，不尚有旧！`
  },
  {
    id: 'ch8',
    title: '第八章：颂',
    unlockAt: 34390, words: 3891,
    preview: '於穆清庙，肃雍显相。济济多士，秉文之德。',
    previewEn: 'Ah, solemn is the pure temple; reverent and bright are its helpers. In ordered ranks stand many officers, holding fast to Wen\'s virtue.',
    highlight: '於穆清庙，肃雍显相。',
    content: `《清庙》
