...
- [x] ~~架构评审实施计划~~ **评审完成（2 P0+4 P1+4 P2，reviews/main-quest-chapter-system-plan-review.md）；D1-D10 全落计划 v2**（小节 check 一等公民/章成遍历全章/键名修复/ceremony 内联/阈值单源/ledger 登记/effects 解耦/迁移补判 check/版本末版+1/删死字段）+ sink-ledger 双线上账
