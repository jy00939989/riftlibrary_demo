...
│   │   └── ...
│   ├── book_pool.js             ← 共享书籍池（商店/里程碑/裴舟推销共用，含plane字段）
...
10 位访客角色：沈明远/程远/裴舟/简安/江有树/谷雨/乔一一/谢如归/夏蝉/王小磊，每位含被动光环 + 三层递进叙事。

刷新机制：
- **专注完成后概率**：perRollChance=20% + 氛围加成 + 光环加成 + 借阅区等级加成 + welcome标志牌+3%
- **长专注多轮抽卡**：每12分钟一次roll，碰中即停
