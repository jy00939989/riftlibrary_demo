...
export const STAGE_WITNESS = {
  ...
  xiachan: {
    2: '哇，补洞的速度比我学一支新舞还快！！不过也对——修房子不用压腿哈哈哈！继续继续！',
    3: '这里的灯光好好看！！不是那种刻意的美，是安静的美。像练功房凌晨五点的光——但是！拍出来更好看！！',
    4: '暖了暖了！！姐妹们总说我还在这行干嘛——但她们不知道，能让人暖起来的地方，舞蹈就不会死！继续跳！！',
    5: '二十三岁在练习生行业算老。但二十三岁在星光下跳舞——我不想用"老"这个字了。我用"刚好"！刚好够成熟，刚好够勇敢！'
  },
  wangxiaolei: {
