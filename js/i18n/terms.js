...
const TERM_DATA = Object.freeze({
  ...
  guideRecopyDesc: { zh: '普通书籍首次完成即解锁全部典藏内容（作者生平、轶事、书评、典藏封面与金光特效），书架上的书会泛起金色光晕。花费 1 灵感可重抄：重抄恢复书籍磨损、获得一半氛围奖励。分卷书需集齐全部卷册后在古籍修复室合成典藏版；典藏版与分卷书不参与重抄。', en: 'Normal books unlock all collector content on first completion—author bio, anecdotes, reviews, collector cover with a golden glow that shimmers on your shelf. Recopy for 1 inspiration to restore wear and earn half atmosphere. Volume books must be collected in full to craft the Collector\'s Edition in the Restoration Room; collector editions and volumes cannot be recopied.' },
