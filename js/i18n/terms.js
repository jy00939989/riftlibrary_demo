...
const TERM_DATA = Object.freeze({
  ...
  guideRestorationDesc: { zh: '在商店解锁古籍修复室后，损坏的书籍可送入修复室。通过投入誊抄字数修复，修复室等级越高修复速度越快。修复完成后书籍恢复可抄状态。', en: 'Unlock the Restoration Room in the shop to repair damaged books. Invest copied words to repair; higher room levels repair faster. Once repaired, books become copyable again.' },
