...
const TERM_DATA = Object.freeze({
  ...
  musicTrack_winter: { zh: '维瓦尔第·冬', en: 'Vivaldi · Winter' },
  musicTrack_spring: { zh: '维瓦尔第·春', en: 'Vivaldi · Spring' },
  ...
  tabMusicRoom: { zh: '音律阁', en: 'Music Hall' },
  musicRoomLocked: { zh: '音律阁尚未解锁', en: 'The Music Hall is locked' },
  ...
  musicRoomUnlockedHint: { zh: '已解锁 · 前往音律阁聆听', en: 'Unlocked · Visit the Music Hall' },
