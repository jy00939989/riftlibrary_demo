...
const TERM_DATA = Object.freeze({
  ...
  guideRecopyDesc: { zh: '普通书籍首次完成后即可解锁重抄，花费 1 灵感重新誊抄。重抄可提升熟练度，解锁典藏内容（作者生平、轶事、书评、典藏封面）。分卷书需集齐全部卷册后解锁典藏。', en: 'Normal books unlock recopy after first completion for 1 inspiration. Recopy raises mastery and unlocks collector content (author bio, anecdotes, reviews, collector cover). Volume books require collecting all volumes to unlock collector content.' },
