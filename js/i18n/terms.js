...
const TERM_DATA = Object.freeze({
  ...
  faqA2: { zh: '完成书籍首通、访客还书、植物收获、稀层事件与成就奖励都会提升氛围。注意：重抄书籍仅获得一半氛围；藏书厅氛围上限为 500。', en: 'First-time book completion, visitor returns, plant harvests, rare events, and achievements raise atmosphere. Note: recopy gives half atmosphere; the hall atmosphere cap is 500.' },
