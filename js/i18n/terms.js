...
const TERM_DATA = Object.freeze({
  ...
  // ========== 展览厅（exhibition-hall-plan v2） ==========
  exhHallFlavor: { zh: '全馆收藏品的「家」与限时活动举办地。修复房间，把成就与回忆一件件陈列出来。', en: 'The home of the collection and host of limited-time events. Restore the rooms and display your achievements and memories.' },
  exhHallBuildTitle: { zh: '奠基展览厅大厅', en: 'Found the Exhibition Hall' },
  ...
  exhGoShopBuild: { zh: '去位面商店建造', en: 'Build in Plane Shop' },
  exhRepairTitle: { zh: '修复 · {room}', en: 'Restore · {room}' },
  exhRepair: { zh: '修复', en: 'Restore' },
  exhRepairDone: { zh: '修复开放！', en: 'Restored!' },
  exhRepairFree: { zh: '免费', en: 'Free' },
  exhConditionSlot: { zh: '大厅容量 ≥ {need}（当前 Lv.{have}）', en: 'Hall capacity ≥ {need} (now Lv.{have})' },
  exhConditionCoins: { zh: '智慧之光 ≥ {price}', en: 'Wisdom Light ≥ {price}' },
  exhCondSignboard: { zh: '拥有 ≥{need} 块纪念牌（当前 {have}）', en: 'Own ≥{need} signboard(s) (now {have})' },
  exhCondAchievements: { zh: '成就 ≥{need} 个（当前 {have}）', en: 'Achievements ≥{need} (now {have})' },
  ...
  exhLegacyNote: { zh: '馆史档案、留声阁等旧入口即将收编入展览厅，下个版本统一导航。', en: 'Legacy entries (Archive, Music Room, etc.) will soon fold into the Exhibition Hall. Navigation unifies next version.' },
  exhGrandTitle: { zh: '🎊 展览厅全馆开放！', en: '🎊 Grand Opening of the Exhibition Hall!' },
  exhGrandDesc: { zh: '五个房间全部开放，全馆的成就与回忆都有了陈列的家。', en: 'All five rooms are open. The collection finally has its home.' },
  roomArchive: { zh: '档案室', en: 'Archive Room' },
  roomSignboards: { zh: '纪念牌墙', en: 'Plaque Wall' },
  roomAchievements: { zh: '成就柜', en: 'Trophy Cabinet' },
  roomCollection: { zh: '收藏品展柜', en: 'Display Case' },
  roomMusicroom: { zh: '留声阁', en: 'Music Room' },
  // 墨墨「展厅巡查」叙事（房间修复一句 + 全馆开放一句）
  exhPatrolArchive: { zh: '墨墨在大厅转了一圈：卷宗门后的档案室随馆而生，馆的记忆从此有了家。', en: 'Momo paced the hall: the Archive Room behind the scroll door is born with the library. The library\'s memory finally has a home.' },
  exhPatrolSignboards: { zh: '展厅巡查：纪念牌墙擦得发亮，第一块牌子挂上去的时候，整个大厅都庄重了起来。', en: 'Gallery patrol: the Plaque Wall polished bright. When the first plaque went up, the whole hall stood a little taller.' },
  exhPatrolAchievements: { zh: '展厅巡查：成就柜的阶梯展台装好了，每一格都在等一个被完成的目标。', en: 'Gallery patrol: the trophy cabinet\'s tiered stands are ready. Every shelf waits for a completed goal.' },
  exhPatrolCollection: { zh: '展厅巡查：收藏品展柜的玻璃擦得一尘不染，就等第一件宝贝入住。', en: 'Gallery patrol: the display case glass is spotless, waiting for its first treasure.' },
  exhPatrolGrandOpening: { zh: '展厅巡查：五个房间全部开放——归墟的展览厅，从今天起全馆迎客。', en: 'Gallery patrol: all five rooms are open. From today, the Gui Xu Exhibition Hall welcomes all.' },
  exhDiaryEvent: { zh: '今天是{event}，展览厅挂起了活动横幅。', en: "Today is {event}. The Exhibition Hall raised its event banner." },
  // 活动日历（data/event_calendar.js 锚点，图南圈定四位 + 克克补位两位）
  evtTolkienBirthday: { zh: '托尔金诞辰', en: "Tolkien's Birthday" },
  evtChildrenBookDay: { zh: '国际儿童图书日', en: "International Children's Book Day" },
  evtWorldBookDay: { zh: '世界读书日 · 书香苏州', en: 'World Book Day' },
  evtAgathaBirthday: { zh: '阿加莎·克里斯蒂诞辰', en: "Agatha Christie's Birthday" },
  evtLuxunBirthday: { zh: '鲁迅诞辰', en: "Lu Xun's Birthday" },
  ...
  stageCeremonyBtn: { zh: '✨ 举行升阶仪式', en: '✨ Hold the Ascension Ceremony' },
  stageCeremonyHint: { zh: '氛围与设施均已就绪，点击迈入下一阶段', en: 'Atmosphere and facilities are ready — click to ascend' },
  stageUpWaiting: { zh: '氛围已达下一阶，升阶还需：', en: 'Atmosphere threshold reached. Ascension still requires:' },
  todayLibrary: { zh: '今日图书馆', en: 'Library Today' },
  transcribeSpeedLabel: { zh: '誊抄速度', en: 'Copy Speed' },
  speedTooltipTitle: { zh: '誊抄速度加成说明', en: 'Copy Speed Breakdown' },
  speedTooltipScriptorium: { zh: '缮写室等级 Lv.{lv}', en: 'Scriptorium Lv.{lv}' },
  speedTooltipSignboard: { zh: '标志牌', en: 'Signboards' },
  ...
  planeUnlockRequirements: { zh: '需要：氛围达 {stage} 阶 · 拥有 ≥{books} 本书 · 购买传送门', en: 'Requires: Stage {stage} Atmosphere · ≥{books} books · purchase a Portal' },
  unknownPlane: { zh: '？？？', en: '???' },
  ...
  // ========== 2026 中秋·国庆双节活动 ==========
  festivalMidAutumnTitle: { zh: '中秋 · 国庆 双节同庆', en: 'Mid-Autumn & National Day Festival' },
  festivalMidAutumnDesc: { zh: '月满人间，家国同梦。归墟图书馆为每一位读者备了一份双节礼——推开门，就放在你的桌上。', en: 'The moon is full and the realm celebrates. A festival gift from the Gui Xu Library awaits on your desk.' },
  festivalGiftLabel: { zh: '🎁 双节礼', en: '🎁 Festival Gift' },
  festivalGiftBtn: { zh: '收下礼物 🌕', en: 'Accept the Gift 🌕' },
  festivalSignboardLabel: { zh: '活动限定', en: 'Event Exclusive' },
  cafeRecipeMooncakeTea: { zh: '桂花月饼茶', en: 'Osmanthus Mooncake Tea' },
  diaryFestivalGift: { zh: '🌕 {title}——图书馆挂起了圆月灯，墨墨把一份节日礼物推到你手边：智慧之光、灵感、三样种子，还有一块中秋纪念牌。她说，月亮圆的时候，读书人的笔也会格外稳。', en: '🌕 {title} — the library hung moon lanterns. Momo nudged a festival gift your way: coins, inspiration, three kinds of seeds, and a Mid-Autumn plaque. "The pen writes steadier under a full moon," she says.' },
  evtMidAutumn: { zh: '中秋节', en: 'Mid-Autumn Festival' },
  evtNationalDay: { zh: '国庆节', en: 'National Day' },
  evtMidAutumnNationalBanner: { zh: '中秋 · 国庆 双节同庆', en: 'Mid-Autumn & National Day' },
  tutorialGreenhouseDesc: { zh: '每一分钟专注都会变成一滴水。在这里种下植物，看它们从幼苗长到绽放。', en: 'Every minute of focus becomes a drop of water. Plant seeds here and watch them grow from sprouts to full bloom.' },
  tutorialGreenhouseWater: { zh: `💧 浇水 — 专注 ≥20 分钟 +1 次，全局累积，可浇任意一盆`, en: `💧 Watering — +1 per 20+ min focus, pooled globally, spendable on any pot` },
  tutorialGreenhouseFacilities: { zh: `🛠️ {facilities} — 喷壶一瓢浇多盆、水箱让长专注多得水、绿手指越种越熟`, en: `🛠️ {facilities} — better cans splash more pots, tanks reward long focus, green thumb grows with harvests` },
  tutorialGreenhouseSeeds: { zh: `🌰 {seeds} — 收获概率掉落，可兑换限定书，也能嫁接改良（掉率提升 + 多年生）`, en: `🌰 {seeds} — drop on harvest; exchange for limited books or graft for a better, perennial variety` },
  tutorialGreenhousePots: { zh: `🪴 {pots} — 金币解锁至多 {max} 盆；植物 {hours} 小时不浇水会凋谢`, en: `🪴 {pots} — unlock up to {max} pots with coins; plants wither if unwatched for {hours}h` },
  ...
  recopyUnavailable: { zh: '🔒 典藏版 · 不可重抄', en: '🔒 Collector’s Edition · No Recopy' },
  collectorNoRecopyHint: { zh: '分卷书集齐全部卷册后，可在古籍修复室合成典藏版；典藏版已是终点形态，无需再抄。', en: 'Collect all volumes to craft the Collector’s Edition in the Restoration Room. The Collector’s Edition is the final form—no need to copy further.' },
  ...
  // ========== 熟练度等级 ==========
  masteryName1: { zh: '在架', en: 'Shelved' },
  masteryName2: { zh: '典藏', en: "Collector's Edition" },
  ...
  masteryUnlockOnRecopy: { zh: '花费 1 灵感重抄后解锁（2026-09-20 重新拍板：重抄一次即成典藏）', en: 'Unlock by spending 1 inspiration to recopy (re-confirmed 2026-09-20: one recopy crafts the Collector\'s Edition)' },
  ...
  achName_B07: { zh: '五书在架', en: 'Five on the Shelf' },
  ...
  achDesc_B07: { zh: '5本书完成誊抄并上架', en: 'Complete and shelve 5 books' },
  achDesc_B08: { zh: '3本书重抄成为典藏', en: "Craft 3 Collector's Editions (one recopy each)" },
  achDesc_B09: { zh: '在古籍修复室首次合成一本典藏版', en: 'Craft your first Collector Edition in the Restoration Room' },
  achDesc_L01: { zh: '氛围脱离废墟阶段（≥400）', en: 'Atmosphere rises above the ruins stage (≥400)' },
  achDesc_L02: { zh: '购买第一个新书架', en: 'Purchase your first new bookshelf' },
  achDesc_L02b: { zh: '购买第一本书', en: 'Purchase your first book' },
  achDesc_L03: { zh: '氛围达到陈旧阶段（≥900）', en: 'Atmosphere reaches the Weathered stage (≥900)' },
  achDesc_L04: { zh: '借阅区升至Lv3', en: 'Reading Area reaches Lv.3' },
  achDesc_L05: { zh: '氛围达到温暖阶段（≥2,800）', en: 'Atmosphere reaches the Warm stage (≥2,800)' },
  achDesc_L06: { zh: '借阅区升至Lv7', en: 'Reading Area reaches Lv.7' },
  achDesc_L07: { zh: '氛围达到星辰阶段（≥5,600）', en: 'Atmosphere reaches the Starlight stage (≥5,600)' },
  ...
  t5g4: { zh: '氛围达到 5,600', en: 'Reach 5,600 Atmosphere' },
  ...
  // ========== 访客纪念 ==========
  collectionCategoryVisitorMemory: { zh: '访客纪念', en: 'Visitor Memories' },
  diaryTabVisitorMemory: { zh: '访客纪念', en: 'Visitor Memories' },
  vmFilterAll: { zh: '全部', en: 'All' },
  vmFilterNote: { zh: '便签', en: 'Notes' },
  vmFilterEvent: { zh: '事件', en: 'Events' },
  vmEmpty: { zh: '还没有收集到任何访客便签或事件', en: 'No visitor notes or events collected yet' },
  vmNew: { zh: '新', en: 'NEW' },
  vmCollected: { zh: '已收集 {collected}/{total}', en: 'Collected {collected}/{total}' },
  vmMarkAllRead: { zh: '全部已读', en: 'Mark all read' },
  vmKindNote: { zh: '便签', en: 'Note' },
  vmKindEvent: { zh: '事件', en: 'Event' },
  vmRarityOccasional: { zh: '偶发', en: 'Occasional' },
  vmRarityRare: { zh: '稀层', en: 'Rare' },
  vmRarityPostRare: { zh: '终局', en: 'Finale' },
  vmRarityPostRareOccasional: { zh: '终局后', en: 'Post-Finale' },
  vmRaritySpecial: { zh: '特殊', en: 'Special' },

  // 访客纪念 — 特殊事件
  vmEventShenGiftBookTitle: { zh: '沈明远赠书', en: "Shen Mingyuan's Gift" },
  vmEventShenGiftBookText: { zh: '{visitor}赠送了一本《{bookTitle}》，说是自己珍藏多年的版本。', en: '{visitor} gifted a copy of “{bookTitle}” from his personal collection.' },
  vmEventPeizhouRecommendTitle: { zh: '裴舟荐书', en: "Peizhou's Recommendation" },
  vmEventPeizhouRecommendText: { zh: '{visitor}推荐了《{bookTitle}》，说“这本在我书店里摆了好久，一直没人带走。”24小时内购买享额外折扣。', en: '{visitor} recommended “{bookTitle}.” “This sat in my shop for ages—no one took it.” Extra discount within 24 hours.' },
  vmEventPeizhouPreviewTitle: { zh: '裴舟赠阅残章', en: "Peizhou's Fragment" },
  vmEventPeizhouPreviewText: { zh: '{visitor}翻了翻你的手稿箱，挑出一本没抄完的。“这段我熟——以前书店里有这本书，我帮人补过好几页。给你添几笔。”', en: '{visitor} rummaged through your manuscript box and picked out an unfinished copy. “I know this passage—used to help customers fill in pages at the shop. Let me add a few strokes.”' },
  vmEventWavePoemTitle: { zh: '王小磊的波浪诗笺', en: "Wang Xiaolei's Wave Poem" },
  vmEventWavePoemText: { zh: '{visitor}在还书时夹了一张诗笺：“{poem}”', en: '{visitor} slipped a poem into the returned book: “{poem}”' },

  // 访客纪念 — 通用事件
  vmEventGenericChengyuanTitle: { zh: '程远分享了他的调试笔记', en: 'Cheng Yuan shared his debugging notes' },
  vmEventGenericChengyuanMsg: { zh: '把代码调试和文本校对做了类比，附赠智慧之光。', en: 'He compared debugging code to proofreading text, and gifted some Wisdom Light.' },
  vmEventGenericJiananTitle: { zh: '简安留下了一页公文背面手稿', en: 'Jian An left a manuscript on the back of an official form' },
  vmEventGenericJiananMsg: { zh: '正面是汇报材料，背面是一段小说开头。', en: 'The front was a report; the back was the opening of a novel.' },
  vmEventGenericJiangyoushuTitle: { zh: '江有树分享了一份修改后的简历', en: 'Jiang Youshu shared a revised résumé' },
  vmEventGenericJiangyoushuMsg: { zh: '在图书馆里改的版本，措辞自信了很多。', en: 'Edited here at the library, the wording sounded far more confident.' },
  vmEventGenericGuyuTitle: { zh: '谷雨夹了一朵野花在书里', en: 'Gu Yu pressed a wildflower into the book' },
  vmEventGenericGuyuMsg: { zh: '村口采的野花，被她仔细压成了标本。', en: 'A wildflower picked at the village entrance, carefully pressed into a specimen.' },
  vmEventGenericQiaoyiyiTitle: { zh: '乔一一画了一张手绘藏书票', en: 'Qiao Yiyi drew an ex libris' },
  vmEventGenericQiaoyiyiMsg: { zh: '原书封底已经破损，她用自己画的藏书票修补了上去。', en: 'The original back cover was worn, so she patched it with her own drawing.' },
  vmEventGenericXieruguiTitle: { zh: '谢如归留了一份SWOT笔记', en: 'Xie Rugui left a SWOT analysis' },
  vmEventGenericXieruguiMsg: { zh: '对《史记》做了商业分析，视角清奇但颇有见地。', en: 'A business-analysis take on Records of the Grand Historian—odd angle, but insightful.' },
  vmEventGenericXiachanTitle: { zh: '夏蝉写了一小段歌词', en: 'Xia Chan wrote a short lyric' },
  vmEventGenericXiachanMsg: { zh: '第四遍的时候哼出来的。前三遍镜子都说不对。', en: 'Hummed it out on the fourth try. The mirror rejected the first three.' },
  ...
  requirements: { zh: '需要：氛围达 {stage} 阶 · 拥有 ≥{books} 本书', en: 'Requires: Stage {stage} Atmosphere · ≥{books} books' },
  ...
  bookConditionLabel: { zh: '书况', en: 'Condition' },
  condition_pristine: { zh: '崭新', en: 'Pristine' },
  condition_good: { zh: '良好', en: 'Good' },
  condition_worn: { zh: '磨损', en: 'Worn' },
  condition_fragile: { zh: '破旧', en: 'Fragile' },
  condition_critical: { zh: '濒危', en: 'Critical' },
  wearDamageRate: { zh: '磨损损毁率 {rate}%', en: 'wear damage {rate}%' },
  wearDamageNote: { zh: '高磨损书籍最高 ×1.6，重抄可恢复如新', en: 'worn books up to ×1.6; recopy restores to pristine' },
  collectorReturnBonus: { zh: '典藏版借出回报：智慧之光 ×2 · 氛围 ×3', en: 'Collector edition loan bonus: coins ×2 · atmosphere ×3' },
  ...
  restorationRoomStatsNotBuilt: { zh: '残破的修复室堆满灰尘，免费修缮后可提速修复、护卷、合成典藏版', en: 'A dusty ruined room; restore it free to speed up repairs, protect volumes, and craft collector editions' },
  restorationRoomStatsUnlockedLevel0: { zh: '已开放：修复提速（升级生效）· 修缮箱护卷 · Lv.1 可合成典藏版', en: 'Open: repair speed (per level) · volume protection box · Lv.1 unlocks collector crafting' },
  restorationRoomStats: { zh: '修复速度 +{value}%', en: 'Repair speed +{value}%' },
  grantRestorationFree: { zh: '免费修缮', en: 'Restore (Free)' },
  restorationGrantHint: { zh: '首次修复受损书籍时，修复室也会自动亮起灯火', en: 'The room also lights up automatically the first time you repair a damaged book' },
  restorationFreeGrantHint: { zh: '首次受灾自动免费点亮，也可前往修复室页提前免费修缮', en: 'Lights up free after your first book is damaged, or restore it free anytime in the Restoration tab' },
  craftRequiresRestorationLevel1: { zh: '修复室升至 Lv.1 后可合成典藏版', en: 'Upgrade the Restoration Room to Lv.1 to craft collector editions' },
  restorationRoomUnlock: { zh: '古籍修复室已解锁', en: 'Restoration Room Unlocked' },
  restorationRoomUpgrade: { zh: '古籍修复室升级', en: 'Restoration Room Upgraded' },
  restorationNarrative0: { zh: '灰尘覆盖的修复室重新亮起了灯。从此，损毁的珍本有了新的归处。', en: 'The dust-covered restoration room lights up again. From now on, damaged rare books have a place to heal.' },
  restorationNarrative1: { zh: '第一批工具归位，墨墨在墙角发现了一只沉睡的修补蜘蛛。', en: 'The first tools are in place. Momo found a sleeping mending spider in the corner.' },
  restorationNarrative2: { zh: '书架被重新加固，泛黄的书页在空气中轻轻颤动。', en: 'The shelves are reinforced, and yellowed pages tremble gently in the air.' },
  restorationNarrative3: { zh: '阳光透过修好的窗棂洒进来，照亮了每一道细小的裂痕。', en: 'Sunlight streams through the repaired window, illuminating every tiny crack.' },
  restorationNarrative4: { zh: '修复室散发出旧纸与墨香混合的气息，时间在这里慢了下来。', en: 'The room exudes a scent of old paper and ink; time slows here.' },
  restorationNarrative5: { zh: '这里已不仅是修复书籍的地方，更是整座图书馆心跳的密室。', en: 'This is no longer just a place to repair books, but the secret chamber of the library’s heartbeat.' },
  restorationNarrativeDefault: { zh: '修复室又向前迈进了一步。', en: 'The restoration room has taken another step forward.' },
  ...
  musicTrack_winter: { zh: '维瓦尔第·冬·意象曲', en: 'Vivaldi\'s Winter, Imagined' },
  musicTrack_spring: { zh: '维瓦尔第·春·意象曲', en: 'Vivaldi\'s Spring, Imagined' },
  musicTrack_rhapsody: { zh: '蓝色狂想曲', en: 'Rhapsody in Blue' },
  ...
  musicRoomShopDesc: { zh: '馆主的唱片陈列室：收集全部乐曲，随时聆听', en: 'The curator\'s record gallery: collect every tune, listen anytime' },
  musicRoomUnlockedHint: { zh: '已解锁 · 前往留声阁聆听', en: 'Unlocked · Visit the Phonograph Hall' },
  musicNothingPlaying: { zh: '暂无播放', en: 'Nothing playing' },
  clickToBuy: { zh: '点击购买', en: 'Click to buy' },
  trackPurchaseSuccess: { zh: '💿 唱片已入库！', en: '💿 Record added to your collection!' },
  trackRequiresBook: { zh: '誊抄《亚瑟王之死》后解锁购买', en: 'Complete "Le Morte d\'Arthur" to unlock purchase' },
  ...
  waterPoolCount: { zh: '浇水次数 ×{n}', en: 'Watering charges ×{n}' },
  waterPoolHint: { zh: '专注即可获得；不管有没有种植物都会累积，可分配给任意一盆', en: 'Earned by focusing; accumulates even with no plants planted, spendable on any pot' },
  plantLossWitherTitle: { zh: '🥀 植物凋谢了', en: '🥀 Your Plant Withered' },
  plantLossWitherDesc: { zh: '{names} 超过 72 小时未照料，枯萎清盆了。浇水可以刷新照料时间——浇水次数全局累积，随时可用。', en: '{names} went 72+ hours without care and withered away. Watering refreshes care time; watering charges accumulate globally and never expire.' },
  plantLossTyphoonTitle: { zh: '🌪️ 台风过境', en: '🌪️ Typhoon Struck' },
  plantLossTyphoonLostDesc: { zh: '{name} 被台风刮走了。新种下的植物有 48 小时保护期，期间台风不会波及。', en: '{name} was swept away by the typhoon. Newly planted crops have a 48-hour grace period.' },
  plantLossTyphoonSavedDesc: { zh: '谷雨拼命抢回了{name}，它活下来了，但被吹落了一级。', en: 'Guyu held onto {name} with all her might—it survived, but dropped a level.' },
  diaryPlantWither: { zh: '🥀 {names}凋谢了——超过三天没人照料，叶子落了一地。墨墨把枯枝收进角落，在日记里画了一片打蔫的叶子。', en: '🥀 {names} withered—three days without care, leaves all over the floor. Momo gathered the dry stems into a corner and drew a drooping leaf in the diary.' },
  ...
  plantLogFilter_harvest: { zh: '收获', en: 'Harvests' },
  plantLogFilter_perennial: { zh: '多年生', en: 'Perennial' },
  plantLogFilter_gone: { zh: '消失', en: 'Gone' },
  plantLogEmpty: { zh: '还没有记录——种下第一颗种子，或等第一株植物长大吧。', en: 'No records yet—plant your first seed and watch it grow.' },
  ...
  plantPotsTitle: { zh: '盆栽', en: 'Potted Plants' },
  plantPotCount: { zh: '{n}/{max} 盆', en: '{n}/{max} pots' },
  plantPotEmpty: { zh: '空花盆', en: 'Empty pot' },
  plantPotUnlock: { zh: '解锁新盆', en: 'Unlock New Pot' },
  plantPotMax: { zh: '花盆已达上限', en: 'All pots unlocked' },

  // ========== 温室培育线（2026-09-21 图南四决策） ==========
  greenhouseFacilities: { zh: '培育设施', en: 'Cultivation Facilities' },
  canWatering: { zh: '浇水壶', en: 'Watering Can' },
  canWateringDesc: { zh: '1 次浇水浇 1 盆', en: '1 charge waters 1 pot' },
  canLongSpout: { zh: '长嘴喷壶', en: 'Long-Spout Can' },
  canLongSpoutDesc: { zh: '1 次浇水浇 2 盆：点击盆 + 最缺水的一盆，各全额成长', en: '1 charge waters 2 pots: the tapped pot plus the thirstiest, full growth each' },
  canSprinkler: { zh: '花洒', en: 'Sprinkler Can' },
  canSprinklerDesc: { zh: '1 次浇水浇全部活盆，2 份成长均分（盆再多也是一键均匀浇透）', en: '1 charge waters all active pots, 2 shares split evenly—one tap, every pot' },
  tankClayJar: { zh: '陶罐', en: 'Clay Jar' },
  tankClayJarDesc: { zh: '专注 ≥20 分钟 +1 浇水次数（基础档位）', en: 'Focus ≥20 min: +1 charge (base tier)' },
  tankCopper: { zh: '铜水箱', en: 'Copper Tank' },
  tankCopperDesc: { zh: '专注 ≥45 分钟再 +1；离线每 6 小时 +1（上限 4）', en: 'Focus ≥45 min: +1 more; offline +1 per 6h (cap 4)' },
  tankArcane: { zh: '魔导蓄水池', en: 'Arcane Reservoir' },
  tankArcaneDesc: { zh: '专注 ≥45/≥90 分钟各再 +1；离线每 3 小时 +1（上限 8）', en: 'Focus ≥45/≥90 min: +1 each; offline +1 per 3h (cap 8)' },
  greenThumb: { zh: '绿手指', en: 'Green Thumb' },
  greenThumbDesc: { zh: '累计收获升级，每级浇水/施肥成长 +5%', en: 'Levels up with lifetime harvests; +5% water/fertilize growth per level' },
  greenThumbProgress: { zh: '累计收获 {n} 次', en: '{n} lifetime harvests' },
  greenThumbMaxed: { zh: '已满级 · 累计收获 {n} 次', en: 'Max level · {n} lifetime harvests' },
  facilityUpgrade: { zh: '升级 💰{price}', en: 'Upgrade 💰{price}' },
  facilityMaxed: { zh: '已满级', en: 'Max tier' },
  waterSplashTwo: { zh: '💧 浇水 ×2盆', en: '💧 Water ×2 pots' },
  waterSplashAll: { zh: '🌧️ 花洒全盆 (+{per}/盆)', en: '🌧️ Splash all (+{per}/pot)' },
  improvedBadge: { zh: '🧬 改良', en: '🧬 Improved' },
  perennialChanceHint: { zh: '多年生：收获后 {p}% 概率回落 Lv3 重长，否则凋谢', en: 'Perennial: {p}% chance to regrow from Lv3 after harvest' },
  harvestPerennialRegrow: { zh: '多年生萌发：回落 Lv3 继续生长', en: 'Perennial regrowth: falls back to Lv3 and keeps growing' },
  unlockImprovedTitle: { zh: '🔬 嫁接改良', en: '🔬 Graft Improvement' },
  improveTierProgress: { zh: '{n}/5 档', en: 'Tier {n}/5' },
  improveNextDrop: { zh: '下档：掉率 {rate}%', en: 'Next: {rate}% drop' },
  improveNextPerennial: { zh: '下档：多年生 {p}%', en: 'Next: {p}% perennial' },
  improveMaxed: { zh: '✅ 已满级（掉率 80% · 多年生 100%）', en: '✅ Maxed (80% drop · 100% perennial)' },
  needSeedsToImprove: { zh: '还需 {n} 颗种子', en: '{n} more seeds needed' },
  // 咖啡角（cafe-corner-plan v3.1）
  cafeRecipeVanillaTea: { zh: '香草茶', en: 'Vanilla Tea' },
  cafeRecipeRoseDew: { zh: '玫瑰露', en: 'Rose Dew' },
  cafeRecipeStarlightSpecial: { zh: '星蕨特调', en: 'Starlight Special' },
  cafePanelTitle: { zh: '咖啡角', en: 'Café Corner' },
  cafeConcurrentCap: { zh: '同时接待上限', en: 'Concurrent Seats' },
  cafeBorrowBuffDesc: { zh: '进店借书概率', en: 'Borrow Chance on Visit' },
  cafeFavorMultDesc: { zh: '招待好感倍率', en: 'Favor Multiplier' },
  cafeTotalServed: { zh: '累计招待', en: 'Total Served' },
  cafeDailyFee: { zh: '维持费 {n}/活跃日', en: 'Upkeep {n}/active day' },
  cafeAutoServeHint: { zh: '有库存时访客会自动进店，招待得金币与好感', en: 'Visitors enter automatically when stocked; serving earns coins and favor' },
  cafeDormant: { zh: '休眠中', en: 'Dormant' },
  cafeDormantHint: { zh: '金币不足以支付维持费，已暂停营业；金币回升自动唤醒', en: 'Not enough coins for upkeep; business paused. Recovers automatically when coins are sufficient.' },
  cafeStockLabel: { zh: '库存', en: 'Stock' },
  cafeCraft: { zh: '制作', en: 'Craft' },
  cafeCrafted: { zh: '制作完成，已入库', en: 'Crafted and added to stock' },
  cafeNextLevelPreview: { zh: '下一级', en: 'Next Level' },
  cafeMaxed: { zh: '已满级', en: 'Max Level' },
  cafeEnter: { zh: '进入咖啡角', en: 'Enter Café' },
  cafeBuildGate: { zh: '{stage} 阶可建造', en: 'Requires Stage {stage}' },
  ...
  // ========== 馆长办公室 / 指南 ==========
  curatorOfficeGuide: { zh: '🏛️ 馆长手册', en: "🏛️ Curator's Guide" },
  guideWelcome: { zh: '欢迎来到归墟图书馆。这座废墟因你的专注而复苏，请收好这份馆长手册。', en: 'Welcome to the Gui Xu Library. These ruins revive through your focus—keep this guide close.' },
  guideOverviewDesc: { zh: '概况 — 图书馆数据总览、氛围阶段、修改馆名、连续专注天数', en: 'Overview — library stats, atmosphere stage, rename your library, focus streak' },
  guideAchievementsDesc: { zh: '成就柜 — 查看已解锁成就、未达成条件与阶段奖励', en: 'Achievements — view unlocked, pending, and stage rewards' },
  guideCollectionDesc: { zh: '收藏室 — 书籍、位面、访客记忆、典藏版与全收集进度', en: 'Collection — books, planes, visitor memories, collector editions, and completion' },
  guideDecorationDesc: { zh: '布置 — 植物盆栽、种子库存、标志牌与限量挂牌', en: 'Decor — plants, seeds, signboards, and limited plaques' },
  guideGuideDesc: { zh: '馆长手册 — 你正在看这里，游戏机制与常见问题', en: "Curator's Guide — you are reading it: mechanics and FAQ" },
  ...
  coreLoopDetail: { zh: '这是图书馆复苏的核心循环。专注产生资源，资源升级设施，设施吸引访客，访客带来还书收益与故事。', en: "This is the core loop of the library's revival: focus yields resources, resources upgrade facilities, facilities attract visitors, and visitors bring returns and stories." },
  guideResourcesTitle: { zh: '💎 核心资源', en: '💎 Core Resources' },
  guideResourcesDesc: { zh: '· 智慧之光（💰）：主要用于商店购买、设施升级\n· 灵感（✨）：解锁章节、触发访客稀层事件\n· 氛围（🌟）：决定图书馆阶段，影响访客、BGM 与视觉效果；上限 500\n· 种子（🌱）：植物收获后获得，可在种子商店兑换限定书、资源或新种子', en: '· Wisdom Light (💰): used in shop purchases and facility upgrades\n· Inspiration (✨): unlocks chapters and triggers visitor rare events\n· Atmosphere (🌟): determines library stage, affecting visitors, BGM, and visuals; cap 500\n· Seeds (🌱): gained from harvesting plants; exchange in seed shop for limited books, resources, or new seeds' },
  guideFocusTitle: { zh: '🖋️ 专注誊抄', en: '🖋️ Focus Copy' },
  guideFocusDesc: { zh: '在缮写室选择一本书进入专注。每专注 1 分钟获得 0.8 智慧之光；专注完成后根据已解锁章节推进誊抄进度。完成书籍可获得氛围与金币奖励，首次完成全额、重抄仅获一半氛围。', en: 'Pick a book in the Scriptorium to focus. Each minute yields 0.8 Wisdom Light; completion advances copy progress by unlocked chapters. Finishing a book grants atmosphere and coins—first completion full, recopy half atmosphere.' },
  guideVisitorTitle: { zh: '👥 访客系统', en: '👥 Visitors' },
  guideVisitorDesc: { zh: '访客会在图书馆浏览、借书、归还。还书时给予智慧之光、氛围与好感度。借阅区等级越高，访客容量与还书收益越高。与访客好感达到阈值后可触发偶层、稀层与终局事件。', en: 'Visitors browse, borrow, and return books. Returns give Wisdom Light, atmosphere, and favor. Higher Reading Area levels increase capacity and return rewards. Reaching favor thresholds triggers occasional, rare, and finale events.' },
  guideItemTitle: { zh: '🎒 道具与行囊', en: '🎒 Items & Bag' },
  guideItemDesc: { zh: '通过兑换码或后续系统可获得道具，在顶部导航栏「行囊」中使用。\n· 笔类：莎草芦管（+1 万字）、天鹅翎管（+2 万字）、秘银笔尖（+3 万字），对书籍使用\n· 修缮符：一次性完全修复一本损坏书籍\n· 心意便签：指定访客 +20 好感\n· 随机便签：随机访客 +20 好感', en: 'Obtain items via redeem codes or future systems; use them in the top-nav Bag.\n· Brushes: Reed Pen (+10k), Swan Quill (+20k), Mithril Nib (+30k), used on books\n· Restoration Scroll: instantly fully repair one damaged book\n· Personal Favor Note: +20 favor to a chosen visitor\n· Mystery Favor Note: +20 favor to a random visitor' },
  guideRedeemTitle: { zh: '🎁 兑换码与纪念牌', en: '🎁 Redeem Codes & Plaques' },
  guideRedeemDesc: { zh: '账号面板内可输入兑换码领取礼包。纪念牌是限量藏品，装备后提供全局加成：\n· 先驱者的墨印：+3% 专注效率（限量 10）\n· 开馆纪念牌：+2% 专注效率（限量 100）', en: 'Enter redeem codes in the Account panel. Plaques are limited collectibles that grant global bonuses:\n· Pioneer Ink: +3% focus efficiency (limited 10)\n· Opening Plaque: +2% focus efficiency (limited 100)' },
  guideRestorationTitle: { zh: '🔧 古籍修复室', en: '🔧 Restoration Room' },
  guideRestorationDesc: { zh: '书籍受损后，在专注页选择该书誊抄即为修复（损坏书卡上有「去修复」按钮直达）。古籍修复室免费开放：首次受灾自动点亮，也可提前免费修缮；升级提升修复速度，修缮箱可寄存单卷免灾，升至 Lv.1 后可合成典藏版。', en: 'To repair a damaged book, select it in the Focus page and copy (damaged book cards have a Repair Now shortcut). The Restoration Room is free: it lights up automatically on your first book damage (or restore it free anytime); upgrades speed up repairs, the box protects volumes from damage, and Lv.1 unlocks collector edition crafting.' },
  guideRecopyTitle: { zh: '🔮 重抄与典藏', en: '🔮 Recopy & Collection' },
  guideRecopyDesc: { zh: '普通书籍首次完成后即誊抄完成并上架，同时解锁重抄——花费 1 灵感重新誊抄一次，即成典藏（解锁作者生平、轶事、书评、典藏封面与金光特效）。重抄恢复书籍磨损、获得一半氛围奖励。分卷书需集齐全部卷册后在古籍修复室合成典藏版；典藏版与分卷书不参与重抄。', en: 'First completion shelves a normal book and unlocks recopy. Spend 1 inspiration to copy it once more and craft the Collector\'s Edition (author bio, anecdotes, reviews, collector cover with a golden glow). Recopying also restores wear and earns half atmosphere. Volume books must be collected in full to craft the Collector\'s Edition in the Restoration Room; collector editions and volumes cannot be recopied.' },
  guidePlantTitle: { zh: '🌱 植物与种子', en: '🌱 Plants & Seeds' },
  guidePlantDesc: { zh: '在布置页种植植物，浇水施肥后收获。收获提供氛围、智慧之光与种子。种子可在种子商店兑换限定书籍、资源、新种子或氛围。', en: 'Plant in the Decor page; water and fertilize to harvest. Harvests provide atmosphere, Wisdom Light, and seeds. Seeds can be exchanged in the seed shop for limited books, resources, new seeds, or atmosphere.' },
  faq: { zh: '❓ 常见问题', en: '❓ FAQ' },
  ...
  faqA2: { zh: '完成书籍首通、访客还书、植物收获、稀层事件与成就奖励都会提升氛围。注意：重抄书籍仅获得一半氛围。', en: 'First-time book completion, visitor returns, plant harvests, rare events, and achievements raise atmosphere. Note: recopy gives half atmosphere.' },
  ...
  faqA6: { zh: '点击顶部导航栏右侧的 🔈 按钮，或在设置中调整音量。', en: 'Tap the 🔈 button on the top nav or adjust volume in settings.' },
  faqQ7: { zh: 'Q: 道具怎么用？', en: 'Q: How do I use items?' },
  faqA7: { zh: '点击顶部导航栏的「行囊」，选择道具后按提示选择目标（书籍、损坏书籍或访客）使用。', en: "Tap 'Bag' in the top nav, select an item, then choose its target (book, damaged book, or visitor) to use it." },
  faqQ8: { zh: 'Q: 兑换码在哪里输入？', en: 'Q: Where do I enter redeem codes?' },
  faqA8: { zh: '点击顶部导航栏头像打开账号面板，在兑换码入口输入。', en: 'Tap the avatar in the top nav to open the account panel and enter codes there.' },
  faqQ9: { zh: 'Q: 古籍修复室怎么解锁？', en: 'Q: How do I unlock the Restoration Room?' },
  faqA9: { zh: '在商店购买「古籍修复室」解锁。解锁后损坏的书籍会自动或手动送入修复室。', en: 'Purchase the Restoration Room in the shop. Damaged books can then be sent there manually or automatically.' },
  faqQ10: { zh: 'Q: 植物收获后还能做什么？', en: 'Q: What can I do after harvesting plants?' },
  faqA10: { zh: '获得种子后，进入布置页的种子商店兑换限定书、智慧之光、氛围、灵感或新种子。', en: 'After gaining seeds, open the seed shop in the Decor page to exchange for limited books, Wisdom Light, atmosphere, inspiration, or new seeds.' },
  faqQ11: { zh: 'Q: 限量挂牌会叠加吗？', en: 'Q: Do limited plaques stack?' },
  faqA11: { zh: '同类型纪念牌效果不叠加；不同类型可共存，专注效率加成会聚合计算。', en: 'Same-type plaque effects do not stack; different types coexist, and focus efficiency bonuses are aggregated.' },
  faqQ12: { zh: 'Q: 书籍损毁了怎么办？', en: 'Q: What if a book is damaged?' },
  faqA12: { zh: '在专注页选择损坏的书开始誊抄即为修复（书卡上有「去修复」按钮直达）。修复室免费开放，升级可加快修复速度。', en: "Select the damaged book in the Focus page and copy to repair it (damaged cards have a Repair Now shortcut). The Restoration Room is free; upgrading it speeds up repairs." },
  ...
  // ========== 账号 / 云端同步 ==========
  accountCloudSyncTitle: { zh: '账号 / 云端同步', en: 'Account / Cloud Sync' },
  accountEmailLabel: { zh: '邮箱', en: 'Email' },
  accountPasswordLabel: { zh: '密码', en: 'Password' },
  accountSignUp: { zh: '注册', en: 'Sign Up' },
  accountSignIn: { zh: '登录', en: 'Sign In' },
  accountSignOut: { zh: '登出', en: 'Sign Out' },
  accountResendVerify: { zh: '重发验证邮件', en: 'Resend Verification' },
  accountNotConfigured: { zh: '云端同步尚未配置，请在 js/backend/config.local.js 填入 Supabase 项目信息。', en: 'Cloud sync is not configured. Please fill in Supabase project info in js/backend/config.local.js.' },
  accountLoggedInAs: { zh: '当前登录：{email}', en: 'Logged in as: {email}' },
  accountAnonymousUser: { zh: '游客（本地游玩）', en: 'Guest (local only)' },
  accountSyncStatusIdle: { zh: '同步状态：就绪', en: 'Sync: ready' },
  accountSyncStatusSyncing: { zh: '同步状态：同步中…', en: 'Sync: syncing…' },
  accountSyncStatusError: { zh: '同步状态：出错（{error}）', en: 'Sync: error ({error})' },
  accountVerifyEmailSent: { zh: '验证邮件已发送，请查收邮箱（含垃圾邮件文件夹）。', en: 'Verification email sent. Please check your inbox (including spam).' },
  accountPasswordRequirement: { zh: '密码至少 8 位，且同时包含字母和数字。', en: 'Password must be at least 8 characters with both letters and numbers.' },
  accountActionSuccess: { zh: '操作成功', en: 'Action successful' },
  ...
  accountChangePassword: { zh: '修改密码', en: 'Change Password' },
  accountChangePasswordTitle: { zh: '修改密码', en: 'Change Password' },
  accountChangePasswordDesc: { zh: '请输入当前密码和新密码（至少 8 位，包含字母和数字）。', en: 'Enter your current password and a new password (at least 8 characters with letters and numbers).' },
  accountCurrentPassword: { zh: '当前密码', en: 'Current Password' },
  accountNewPassword: { zh: '新密码', en: 'New Password' },
  accountConfirmPassword: { zh: '确认新密码', en: 'Confirm New Password' },
  accountPasswordMismatch: { zh: '两次输入的新密码不一致。', en: 'The new passwords do not match.' },
  accountCurrentPasswordWrong: { zh: '当前密码错误。', en: 'Current password is incorrect.' },
  accountChangePasswordSuccess: { zh: '密码已修改。', en: 'Password changed.' },
  ...
  // ========== 行囊 / 兑换码 ==========
  bag_title: { zh: '行囊', en: 'Bag' },
  bag_empty: { zh: '这里空空如也。', en: 'Your bag is empty.' },
  item_use: { zh: '使用', en: 'Use' },
  select_book: { zh: '选择要誊抄的书籍', en: 'Select a book to copy' },
  select_damaged_book: { zh: '选择要修复的书籍', en: 'Select a damaged book' },
  select_visitor: { zh: '选择要赠送的角色', en: 'Select a character' },
  no_eligible_book: { zh: '没有可作为目标的书籍', en: 'No eligible book' },
  no_damaged_book: { zh: '没有损坏的书籍', en: 'No damaged book' },
  no_unlocked_visitor: { zh: '没有已解锁的角色', en: 'No unlocked character' },
  redeemCodeLabel: { zh: '兑换礼包码', en: 'Redeem Code' },
  redeemCodeBtn: { zh: '兑换', en: 'Redeem' },
  redeemCodeEmpty: { zh: '请输入兑换码', en: 'Please enter a code' },
  ...
  dlcPackBritishLegendsTitle: { zh: '不列颠传奇', en: 'British Legends' },
  dlcPackBritishLegendsDesc: { zh: '中世纪英格兰的双重回响：比德笔下的教会史，与马洛礼的圆桌骑士传奇。', en: 'A medieval echo from England: Bede\'s church history and Malory\'s Round Table legends.' },
  dlcPackContainsBooks: { zh: '含 {n} 本书', en: '{n} books included' },
  dlcPackPrice: { zh: '解锁费', en: 'Unlock fee' },
  dlcPackUnlock: { zh: '解锁', en: 'Unlock' },
  dlcPackUnlocked: { zh: '已解锁', en: 'Unlocked' },
  dlcPackInsufficientCoins: { zh: '智慧之光不足，无法解锁此补充包。', en: 'Insufficient wisdom light to unlock this pack.' },
  dlcPackUnlockFailed: { zh: '解锁失败，请稍后再试。', en: 'Unlock failed. Please try again later.' },
  dlcPackRedeemCode: { zh: '兑换码', en: 'Redeem Code' },
  dlcPackRedeemDesc: { zh: '输入兑换码以解锁限定补充包。', en: 'Enter a redeem code to unlock special DLC packs.' },
  dlcPackRedeemPlaceholder: { zh: '输入兑换码', en: 'Enter code' },
  ...
  disasterWormTitle: { zh: '蛀虫侵蚀', en: 'Bookworms!' },
  disasterWormDesc: { zh: '冷门书的书页间出现了细小的蛀洞，像被针尖戳了一片星空。', en: 'Tiny wormholes speckle a neglected book\'s pages, like a starfield pricked by a needle.' },
  disasterInkTitle: { zh: '墨水打翻', en: 'Ink Spill!' },
  disasterInkDesc: { zh: '手肘碰翻了墨水瓶，墨迹在纸页上洇开一朵黑色的花。', en: 'Your elbow knocked over the inkpot; the stain blooms like a black flower across the page.' },
  disasterDustTitle: { zh: '书籍积灰', en: 'Dusty Book' },
  disasterDustDesc: { zh: '一本书落满了薄灰，访客们暂时不愿借它。去书架掸一掸吧。', en: 'A book has gathered a film of dust; visitors shy away from it. Dust it off on the bookshelf.' },
  disasterDustLine: { zh: '《{title}》积灰中，暂不可被借阅', en: '"{title}" is dusty and cannot be borrowed for now' },
  disasterTheftTitle: { zh: '书籍失窃！', en: 'Book Stolen!' },
  disasterTheftDesc: { zh: '一本书不见了，现场只留下一片黑色的羽毛。', en: 'A book has vanished, leaving only a single black feather at the scene.' },
  ...
  stolenBadge: { zh: '失窃中 · 约 {days} 天后寻回', en: 'Stolen · returns in ~{days} days' },

  // ========== 占位功能 ==========
  coffeeCorner: { zh: '咖啡角', en: 'Coffee Corner' },
  coffeeCornerDesc: { zh: '把温室种子变成金币与好感：制作饮品，访客自动进店消费，还附借书概率增益', en: 'Turn greenhouse seeds into coins and favor: craft drinks, visitors buy automatically, with a borrow-chance buff' },
